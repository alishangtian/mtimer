package com.alishangtian.mtimer.common.protocol;
...
public class RequestCode {
    ...
    public static final int BROKER_ASK_CLIENT_FOR_MTIMER_PROCESSOR = 402;
    public static final int CLIENT_REGISTER_TO_BROKER = 403;

    public static final int CLIENT_ADD_MTIMER_TO_BROKER = 501;
